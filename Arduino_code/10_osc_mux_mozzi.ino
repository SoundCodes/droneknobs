...
//  kVol16.setFreq(0.041f);
  ...
  v1=v2=v3=v4=v5=v6=v7=v8=v9=v10=127; //=v6=v7=v8=v9=v10=v11=v12=v13=v14=v15=v16
...
void updateControl(){
  ...
  aCos2.setFreq((mozziAnalogRead(A2)*8));
  aCos3.setFreq((mozziAnalogRead(A3)*8));
  aCos4.setFreq((mozziAnalogRead(A4)*8));
  aCos5.setFreq((mozziAnalogRead(A5)*8));
  aCos6.setFreq((mozziAnalogRead(A6)*8));
  aCos7.setFreq((mozziAnalogRead(A7)*8));
  aCos8.setFreq((mozziAnalogRead(A8)*8));
  aCos9.setFreq((mozziAnalogRead(A10)*8));
  aCos10.setFreq((mozziAnalogRead(A11)*8));
